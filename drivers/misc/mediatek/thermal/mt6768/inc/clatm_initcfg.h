...
#define CLATM_INIT_CFG_0_FIRST_STEP		(3950)
#define CLATM_INIT_CFG_0_THETA_RISE		(2)
#define CLATM_INIT_CFG_0_THETA_FALL		(8)
#define CLATM_INIT_CFG_0_MIN_BUDGET_CHG		(1)
#define CLATM_INIT_CFG_0_MIN_CPU_PWR	(200)
#define CLATM_INIT_CFG_0_MAX_CPU_PWR	(4000)
#define CLATM_INIT_CFG_0_MIN_GPU_PWR	(250)
#define CLATM_INIT_CFG_0_MAX_GPU_PWR	(2200)

#define CLATM_INIT_CFG_1_TARGET_TJ		(85000)
#define CLATM_INIT_CFG_1_EXIT_POINT		(10000)
#define CLATM_INIT_CFG_1_FIRST_STEP		(3950)
#define CLATM_INIT_CFG_1_THETA_RISE		(2)
#define CLATM_INIT_CFG_1_THETA_FALL		(8)
#define CLATM_INIT_CFG_1_MIN_BUDGET_CHG		(1)
#define CLATM_INIT_CFG_1_MIN_CPU_PWR		(200)
#define CLATM_INIT_CFG_1_MAX_CPU_PWR		(4000)
#define CLATM_INIT_CFG_1_MIN_GPU_PWR		(250)
#define CLATM_INIT_CFG_1_MAX_GPU_PWR		(2300)

#define CLATM_INIT_CFG_2_TARGET_TJ		(85000)
...
#define CLATM_INIT_CFG_2_MIN_CPU_PWR		(200)
#define CLATM_INIT_CFG_2_MAX_CPU_PWR		(4000)
#define CLATM_INIT_CFG_2_MIN_GPU_PWR		(250)
#define CLATM_INIT_CFG_2_MAX_GPU_PWR		(2400)
