...
#define MTK_PM_QOS_DDR_OPP_DEFAULT_VALUE		5
#define MTK_PM_QOS_VCORE_OPP_DEFAULT_VALUE		4
#define MTK_PM_QOS_SCP_VCORE_REQUEST_DEFAULT_VALUE	6
#define MTK_PM_QOS_VVPU_OPP_DEFAULT_VALUE		6
#define MTK_PM_QOS_VMDLA_OPP_DEFAULT_VALUE		6
...
#define MTK_PM_QOS_VCORE_DVFS_FORCE_OPP_DEFAULT_VALUE	8
